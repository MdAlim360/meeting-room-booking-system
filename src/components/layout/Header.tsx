...
const Header = () => {
  return (
    <header className="relative w-full h-[370px] md:h-[500px] lg:h-screen flex flex-col justify-center items-center bg-gray-900 overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10  text-white pt-6 md:pt-16 text-center md:text-center lg:text-start px-4 md:px-4 lg:px-0 -ml-0 lg:-ml-[490px] max-w-3xl ">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-6xl font-medium mb-2 sm:mb-6 md:mb-8 lg:mb-10">
          Book Your Ideal <span className="text-yellow-500">Meeting Room</span>{" "}
          with Ease
        </h1>
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-xl mb-2 sm:mb-6 md:mb-8 lg:mb-10 text-gray-300">
